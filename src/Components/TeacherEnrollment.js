    ...
    return(
        ...
        <h2>Teacher Enrollment</h2>
            <form onSubmit={this.handleSubmit} className="teacherEnrollment">
                ...
                <label>Subject
                    <input type="text" name="subject" value={subject} onChange={this.handleChange}></input>
                </label>
                <label>Email
                    <input type="text" name="email" value={email} onChange={this.handleChange}></input>
                </label>
                <label>Zip Code
                    <input type="text" name="zip" min= "5" max="5" value={zip} onChange={this.handleChange}></input>
                </label>
                <label>Phone Number
                    <input type="text" name="phone" min="10" max="10" value={phone} onChange={this.handleChange}></input>
                </label>
